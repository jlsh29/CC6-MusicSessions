...
class _ClassTimeWidgetState extends State<ClassTimeWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClassTimeModel());
  }
    ...
    return AuthUserStreamWidget(
      builder: (context) => StreamBuilder<ScheduleRecord>(
        ...
        builder: (context, snapshot) {
          ...
          final classTimeScheduleRecord = snapshot.data!;
                      ...
                      children: [
                        Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              0.0, 20.0, 0.0, 0.0),
                          child: Text(
                            classTimeScheduleRecord.teacherName,
                        ...
                        Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              0.0, 20.0, 0.0, 0.0),
                          child: Text(
                            classTimeScheduleRecord.instrument,
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                                  fontFamily: 'Readex Pro',
                              ...
                              children: [
                                FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    setState(() {
                                      FFAppState().updateScheduleAtIndex(
                                        0,
                                        (e) =>
                                  ...
                                  text: valueOrDefault<String>(
                                    FFAppState().schedule[0].startTime == null
                                        ? 'Start Time'
                                        : (FFAppState()
                                                .schedule[0]
                                                .hasStartTime()
                                ...
                                Align(
                                  ...
                                  child: FFButtonWidget(
                                    ...
                                    text: valueOrDefault<String>(
                                      FFAppState().schedule[0].endTime == null
                                          ? 'End Time'
                                          : (FFAppState()
                                                  .schedule[0]
                                                  .hasEndTime()
                            ...
                            child: Row(
                              ...
                              children: [
                                FFButtonWidget(
                                  ...
                                  text: valueOrDefault<String>(
                                    FFAppState().schedule[1].startTime == null
                                        ? 'Start Time'
                                        : (FFAppState()
                                                .schedule[1]
                                                .hasStartTime()
                                ...
                                Align(
                                  ...
                                  child: FFButtonWidget(
                                    ...
                                    text: valueOrDefault<String>(
                                      FFAppState().schedule[1].endTime == null
                                          ? 'End Time'
                                          : (FFAppState()
                                                  .schedule[1]
                                                  .hasEndTime()
                            ...
                            child: Row(
                              ...
                              children: [
                                FFButtonWidget(
                                  ...
                                  text: valueOrDefault<String>(
                                    FFAppState().schedule[2].startTime == null
                                        ? 'Start Time'
                                        : (FFAppState()
                                                .schedule[2]
                                                .hasStartTime()
                                ...
                                Align(
                                  ...
                                  child: FFButtonWidget(
                                    ...
                                    text: valueOrDefault<String>(
                                      FFAppState().schedule[2].endTime == null
                                          ? 'End Time'
                                          : (FFAppState()
                                                  .schedule[2]
                                                  .hasEndTime()
                            ...
                            child: Row(
                              ...
                              children: [
                                FFButtonWidget(
                                  ...
                                  text: valueOrDefault<String>(
                                    FFAppState().schedule[3].startTime == null
                                        ? 'Start Time'
                                        : (FFAppState()
                                                .schedule[3]
                                                .hasStartTime()
                                ...
                                Align(
                                  ...
                                  child: FFButtonWidget(
                                    ...
                                    text: valueOrDefault<String>(
                                      FFAppState().schedule[3].endTime == null
                                          ? 'End Time'
                                          : (FFAppState()
                                                  .schedule[3]
                                                  .hasEndTime()
                            ...
                            child: Row(
                              ...
                              children: [
                                FFButtonWidget(
                                  ...
                                  text: valueOrDefault<String>(
                                    FFAppState().schedule[4].startTime == null
                                        ? 'Start Time'
                                        : (FFAppState()
                                                .schedule[4]
                                                .hasStartTime()
                                ...
                                Align(
                                  ...
                                  child: FFButtonWidget(
                                    ...
                                    text: valueOrDefault<String>(
                                      FFAppState().schedule[4].endTime == null
                                          ? 'End Time'
                                          : (FFAppState()
                                                  .schedule[4]
                                                  .hasEndTime()
                              ...
                              children: [
                                  ...
                                  onPressed: () async {
                                    ...
                                    setState(() {
                                      FFAppState().updateScheduleAtIndex(
                                        5,
                                        (e) =>
                                            e..startTime = _model.datePicked11,
                                      );
                                    });
                                  },
                                  text: valueOrDefault<String>(
                                    FFAppState().schedule[5].startTime == null
                                        ? 'Start Time'
                                        : (FFAppState()
                                                .schedule[5]
                                                .hasStartTime()
                                ...
                                Align(
                                  ...
                                  child: FFButtonWidget(
                                    ...
                                    text: valueOrDefault<String>(
                                      FFAppState().schedule[5].endTime == null
                                          ? 'End Time'
                                          : (FFAppState()
                                                  .schedule[5]
                                                  .hasEndTime()
                            ...
                            child: Row(
                              ...
                              children: [
                                FFButtonWidget(
                                  ...
                                  text: valueOrDefault<String>(
                                    FFAppState().schedule[6].startTime == null
                                        ? 'Start Time'
                                        : (FFAppState()
                                                .schedule[6]
                                                .hasStartTime()
                                    ...
                                    onPressed: () async {
                                      ...
                                      setState(() {
                                        FFAppState().updateScheduleAtIndex(
                                          6,
                                          (e) =>
                                              e..endTime = _model.datePicked14,
                                        );
                                      });
                                    },
                                    text: valueOrDefault<String>(
                                      FFAppState().schedule[6].endTime == null
                                          ? 'End Time'
                                          : (FFAppState()
                                                  .schedule[6]
                                                  .hasEndTime()
                    ...
                    Expanded(
                      child: Align(
                        ...
                        child: Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              await classTimeScheduleRecord.reference.update({
                                ...mapToFirestore(
                                  {
                              ...
                              context.goNamed('TeacherHomePage');
                            },
                            text: 'Save',
                            options: FFButtonOptions(
                              height: 40.0,
