...
import 'payment_record_beginner_model.dart';
export 'payment_record_beginner_model.dart';

class PaymentRecordBeginnerWidget extends StatefulWidget {
  const PaymentRecordBeginnerWidget({Key? key}) : super(key: key);

  @override
  _PaymentRecordBeginnerWidgetState createState() =>
      _PaymentRecordBeginnerWidgetState();
}

class _PaymentRecordBeginnerWidgetState
    extends State<PaymentRecordBeginnerWidget> {
  late PaymentRecordBeginnerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PaymentRecordBeginnerModel());
                        ...
                        Expanded(
                          child: Align(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                var beginnerRecordReference =
                                    BeginnerRecord.collection.doc();
                                await beginnerRecordReference
                                    .set(createBeginnerRecordData(
                                  amount: int.tryParse(
                                ...
                                _model.beginner =
                                    BeginnerRecord.getDocumentFromData(
                                        createBeginnerRecordData(
                                          amount: int.tryParse(
                                              _model.numberController2.text),
                                          accountName:
                                        ...
                                        beginnerRecordReference);

                                await currentUserReference!
                                    .update(createUsersRecordData(
                                  beginnerRef: _model.beginner?.reference,
                                ));
