...
import 'payment_record_intermediate_model.dart';
export 'payment_record_intermediate_model.dart';

class PaymentRecordIntermediateWidget extends StatefulWidget {
  const PaymentRecordIntermediateWidget({Key? key}) : super(key: key);

  @override
  _PaymentRecordIntermediateWidgetState createState() =>
      _PaymentRecordIntermediateWidgetState();
}

class _PaymentRecordIntermediateWidgetState
    extends State<PaymentRecordIntermediateWidget> {
  late PaymentRecordIntermediateModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PaymentRecordIntermediateModel());
                        ...
                        Expanded(
                          child: Align(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                var intermediateRecordReference =
                                    IntermediateRecord.collection.doc();
                                await intermediateRecordReference
                                    .set(createIntermediateRecordData(
                                  amount: int.tryParse(
                                ...
                                _model.intermediate =
                                    IntermediateRecord.getDocumentFromData(
                                        createIntermediateRecordData(
                                          amount: int.tryParse(
                                              _model.numberController2.text),
                                          accountName:
                                        ...
                                        intermediateRecordReference);

                                await currentUserReference!
                                    .update(createUsersRecordData(
                                  intermediateRef:
                                      _model.intermediate?.reference,
                                ));
